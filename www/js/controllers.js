angular.module('starter.controllers', [])
        ...
        .controller('SignInCtrl', function ($scope, $rootScope, $state, $ionicHistory, Auth, UserData, $firebase) {
            ...
            /* FOR DEV PURPOSES */
            $scope.user = {
                email: "satish.verma143@gmail.com",
                password: "password"
            };
        ...
        .controller('RegisterHouseCtrl', function ($scope, $state, $ionicHistory, $firebase, $rootScope, UserData, HouseData) {
            ...
            $scope.createHouse = function (house) {
                ...
                myHouses.child($scope.temp.join_code).set(($scope.temp), function () {
                    $scope.temp = {
                        houseid: $scope.temp.join_code//hk.key()//
                    };
                    ...
                    myUser.setPriority($scope.temp.join_code);
                });
                //myHouses.push(($scope.temp), function (newChildRef) {
                //    alert($scope.temp.join_code);
        ...
        .controller('AddMemberCtrl', function ($scope, $rootScope, $state, $ionicHistory, fireBaseData) {
            ...
            $scope.email = "satish.verma143@gmail.com";
        ...
        .controller('ExpensesCtrl', function ($scope, $rootScope, ExpensesData, fireBaseData, $ionicModal) {
            ...
            $scope.getExpenses = function (filter) {
                console.log(filter);
                ExpensesData.getExpenses(fireBaseData.currentData.currentHouse.id,filter).then(function (expenses) {
                    $scope.expenses = expenses;
                    $rootScope.hide();
                });
            };
